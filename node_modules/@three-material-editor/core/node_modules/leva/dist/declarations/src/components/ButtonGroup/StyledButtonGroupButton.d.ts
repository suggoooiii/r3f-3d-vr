export declare const StyledButtonGroupButton: import("@stitches/react").StitchesComponentWithAutoCompleteForJSXElements<"button", {}, import("@stitches/core").TConditions & {
    initial: "";
}, {
    colors: {
