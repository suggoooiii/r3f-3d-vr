...
var vectorPlugin = require('./vector-plugin-a9c1be6c.cjs.prod.js');
var v8n = require('v8n');
...
function getValuesForPaths(data, paths) {
  return Object.entries(vectorPlugin.pick(data, paths)).reduce((acc, [path, {
    value,
    disabled,
    key
  }]) => {
...
const schema$5 = (_o, s) => v8n__default['default']().schema({
...
const SelectContainer = vectorPlugin.styled('div', {
  $leva__flexCenter: '',
  position: 'relative',
  '> svg': {
    pointerEvents: 'none',
...
const NativeSelect = vectorPlugin.styled('select', {
  position: 'absolute',
  top: 0,
  left: 0,
  width: '100%',
...
const PresentationalSelect = vectorPlugin.styled('div', {
  display: 'flex',
  alignItems: 'center',
  width: '100%',
...
function Select({
  ...
  }, keys.map(key => React__default['default'].createElement("option", {
    key: key,
    value: key
  }, key))), React__default['default'].createElement(PresentationalSelect, null, displayValue), React__default['default'].createElement(vectorPlugin.Chevron, {
    toggled: true
  }));
}
...
function SelectComponent() {
  ...
  return React__default['default'].createElement(vectorPlugin.Row, {
    input: true
  }, React__default['default'].createElement(vectorPlugin.Label, null, label), React__default['default'].createElement(Select, {
    id: id,
...
var select = vectorPlugin.createInternalPlugin(vectorPlugin._objectSpread2({
...
const schema$4 = o => v8n__default['default']().color().test(o);
...
const schema$3 = o => v8n__default['default']().string().test(o);
const sanitize$3 = v => {
...
function String$1({
  ...
  return React__default['default'].createElement(vectorPlugin.ValueInput, {
    value: displayValue,
    onUpdate: onUpdate,
    onChange: onChange
  });
...
function StringComponent() {
  ...
  return React__default['default'].createElement(vectorPlugin.Row, {
    input: true
  }, React__default['default'].createElement(vectorPlugin.Label, null, label), React__default['default'].createElement(String$1, {
    displayValue: displayValue,
    onUpdate: onUpdate,
    onChange: onChange
  }));
...
var string = vectorPlugin.createInternalPlugin(vectorPlugin._objectSpread2({
  component: StringComponent
}, props$3));

const schema$2 = o => v8n__default['default']().boolean().test(o);
const sanitize$2 = v => {
...
const StyledInputWrapper = vectorPlugin.styled('div', {
  position: 'relative',
  $leva__flex: '',
  height: '$leva__rowHeight',
  input: {
...
function BooleanComponent() {
  ...
  return React__default['default'].createElement(vectorPlugin.Row, {
    input: true
  }, React__default['default'].createElement(vectorPlugin.Label, null, label), React__default['default'].createElement(Boolean$1, {
    value: value,
    onUpdate: onUpdate,
    id: id
  }));
...
var boolean = vectorPlugin.createInternalPlugin(vectorPlugin._objectSpread2({
...
const Store = function Store() {
    ...
    store.setState(s => {
      ...
      paths.forEach(path => {
        if (path in data) {
          ...
          if (input.__refCount === 0 && input.type in vectorPlugin.SpecialInputTypes) {
            delete data[path];
          }
        }
      });
        ...
        if (!!input) {
          const _ref = newInputData,
            ...
            value
                ...
                rest = vectorPlugin._objectWithoutProperties(_ref, ["type", "value"]);
  ...
  const _getDataFromSchema = (schema, rootPath, mappedPaths) => {
    ...
    Object.entries(schema).forEach(([key, input]) => {
      ...
      if (input.type === vectorPlugin.SpecialInputTypes.FOLDER) {
        ...
        vectorPlugin.warn(vectorPlugin.LevaErrors.DUPLICATE_KEYS, key, newPath, mappedPaths[key]);
      } else {
        ...
        if (typeof input === 'object' && !Array.isArray(input)) {
          const {
            ...
            hint
                ...
                rest = vectorPlugin._objectWithoutProperties(input, ["render", "label", "optional", "disabled", "hint"]);
        ...
        const normalizedInput = vectorPlugin.normalizeInput(_input, newPath);
        ...
        if (normalizedInput) {
          ...
          if (!(input.type in vectorPlugin.SpecialInputTypes)) {
...
function folder(schema, settings) {
  return {
    type: vectorPlugin.SpecialInputTypes.FOLDER,
    schema,
...
function button(onClick) {
  return {
    type: vectorPlugin.SpecialInputTypes.BUTTON,
    onClick
  };
}
...
function buttonGroup(opts) {
  return {
    type: vectorPlugin.SpecialInputTypes.BUTTON_GROUP,
    opts
  };
}
...
function monitor(objectOrFn, settings) {
  return {
    type: vectorPlugin.SpecialInputTypes.MONITOR,
    objectOrFn,
...
function ControlInput(_ref) {
  ...
  if (!Input) {
    vectorPlugin.log(vectorPlugin.LevaErrors.NO_COMPONENT_FOR_TYPE, type, path);
    return null;
  }
...
const specialComponents = {
  [vectorPlugin.SpecialInputTypes.BUTTON]: Button,
  [vectorPlugin.SpecialInputTypes.BUTTON_GROUP]: ButtonGroup,
  [vectorPlugin.SpecialInputTypes.MONITOR]: Monitor
};
const Control = React__default['default'].memo(({
  ...
  if (type in vectorPlugin.SpecialInputTypes) {
...
function useControls(schemaOrFolderName, settingsOrDepsOrSchema, depsOrSettingsOrFolderSettings, depsOrSettings, depsOrUndefined) {
  ...
  const paths = React.useMemo(() => store.orderPaths(Object.values(mappedPaths)), [mappedPaths, store]);
...
vectorPlugin.register('SELECT', select);
vectorPlugin.register('IMAGE', image);
vectorPlugin.register('NUMBER', vectorPlugin.number);
vectorPlugin.register('COLOR', color);
vectorPlugin.register('STRING', string);
vectorPlugin.register('BOOLEAN', boolean);
vectorPlugin.register('INTERVAL', interval);
vectorPlugin.register('VECTOR3D', vector3d);
vectorPlugin.register('VECTOR2D', vector2d);
