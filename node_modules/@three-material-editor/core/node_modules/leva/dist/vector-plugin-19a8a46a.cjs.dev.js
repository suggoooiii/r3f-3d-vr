...
const ErrorList = {
  ...
  [exports.LevaErrors.INPUT_TYPE_OVERRIDE]: type => [`Type cannot be overwritten on update (\`${type}\`)`]
};
...
exports.SpecialInputTypes = void 0;
...
})(exports.SpecialInputTypes || (exports.SpecialInputTypes = {}));

function normalizeInput(input, path) {
  if (typeof input === 'object') {
    if ('type' in input) {
      if (input.type in exports.SpecialInputTypes) return input;
...
function ValueInput(_ref) {
  ...
  return React__default['default'].createElement(InputContainer, null, children && React__default['default'].createElement(InnerLabel, null, children), React__default['default'].createElement(StyledInput, _extends({
    levaType: type,
    id: inputId,
    type: "text",
    spellCheck: "false",
...
function NumberInput({
  ...
  return React__default['default'].createElement(ValueInput, {
    id: id,
    value: value,
    onUpdate: _onUpdate,
    onChange: onChange,
...
function Portal({
  ...
  return React__default['default'].createElement(P.Root, {
    className: className
  }, children);
}
...
function RawLabel(props) {
  ...
  return React__default['default'].createElement(React__default['default'].Fragment, null, optional && React__default['default'].createElement(OptionalToggle, null), hint !== undefined ? React__default['default'].createElement(Tooltip.Root, null, React__default['default'].createElement(Tooltip.Trigger, _extends({
    as: StyledLabel
  }, htmlFor, props)), React__default['default'].createElement(Tooltip.Content, {
    side: "top",
    sideOffset: 2
...
function LabelWithCopy(props) {
  ...
  }, React__default['default'].createElement(RawLabel, props), React__default['default'].createElement("div", {
...
function Label(props) {
  ...
  return copyClipboard && !hideCopyButton ? React__default['default'].createElement(LabelWithCopy, props) : React__default['default'].createElement(RawLabel, props);
}
...
function useValue({
  ...
  const [displayValue, setDisplayValue] = React.useState(format$1(type, value, settings));
  const previousValueRef = React.useRef(value);
  const setFormat = React.useCallback(v => setDisplayValue(format$1(type, v, settings)), [type, settings]);
...
function Number$1({
  ...
  return React__default['default'].createElement(NumberInput, {
    ...
    onUpdate: onUpdate,
    onChange: onChange
  }, !hideLabel && React__default['default'].createElement(InnerNumberLabel, _extends({
...
exports.useDragNumber = useDragNumber;
