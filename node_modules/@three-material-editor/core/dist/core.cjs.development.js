...
var Editor__default = _interopDefault(Editor);
...
var editorState = /*#__PURE__*/valtio.proxy({
  className: '',
  showMenu: false,
  showEditor: false,
  showUniforms: false,
...
utils.devtools(editorState, 'material editor');
...
var generateOBc = function generateOBc(_code) {
  ...
  var oModel = exports.editorContext.monacoRef.editor.getModel(model + '_orig').getValue();
  var mModel = exports.editorContext.monacoRef.editor.getModel(model).getValue();
...
var EditorTabs = function EditorTabs() {
  var snapshot = valtio.useProxy(editorState);
  ...
  return /*#__PURE__*/React__default.createElement("div", {
    ...
    }, value.type === 'frag' ? /*#__PURE__*/React__default.createElement(io5.IoImageOutline, {
      className: styles.colorf
    }) : /*#__PURE__*/React__default.createElement(io5.IoCubeOutline, {
      className: styles.colorv
    }), ' ', "" + name, ' ', /*#__PURE__*/React__default.createElement(io5.IoCloseOutline, {
      onClick: function onClick() {
...
var getShaderWithObc = function getShaderWithObc(material) {
  ...
  var dummyShaderLib = Object.assign({}, THREE.ShaderLib[builtinType] ? THREE.ShaderLib[builtinType] : material);

  if (THREE.ShaderLib[builtinType]) {
...
var LiMenu = function LiMenu(_ref) {
  ...
  var getModif = function getModif(type) {
    if (!exports.editorContext.monacoRef) {
      return;
    }

    var oModel = exports.editorContext.monacoRef.editor.getModel("urn:" + name + "." + type + "_orig");
    var mModel = exports.editorContext.monacoRef.editor.getModel("urn:" + name + "." + type);
  ...
  return /*#__PURE__*/React__default.createElement("li", {
    ...
    onClick: function onClick() {
      ...
      editorState.activeMaterial = value;
      exports.editorContext.activeMaterialRef[value.model] = program;
  ...
  }, type === 'frag' ? /*#__PURE__*/React__default.createElement(io5.IoImageOutline, {
    className: styles.colorf
  }) : /*#__PURE__*/React__default.createElement(io5.IoCubeOutline, {
    className: styles.colorv
  }), ' ', name, ".", type, ' ', getModif(type) && /*#__PURE__*/React__default.createElement("span", {
...
var SubMenu = function SubMenu(_ref) {
  ...
  return programGl && material ? /*#__PURE__*/React__default.createElement("div", {
  ...
  }, open ? /*#__PURE__*/React__default.createElement(ri.RiArrowDownSFill, {
    onClick: function onClick() {
      set(!open);
    }
  }) : /*#__PURE__*/React__default.createElement(ri.RiArrowRightSFill, {
    onClick: function onClick() {
      set(!open);
    }
  }), " ", name, material && material.numberOfMaterialsUser > 1 && /*#__PURE__*/React__default.createElement("span", {
    className: styles$2.multiusers
  }, /*#__PURE__*/React__default.createElement(io5.IoCubeOutline, null), /*#__PURE__*/React__default.createElement("small", null, material.numberOfMaterialsUser)), /*#__PURE__*/React__default.createElement(vsc.VscSettings, {
    className: styles$2.unibtn
  }), material && !material.visible && !material.isEffect ? /*#__PURE__*/React__default.createElement(io5.IoEyeOffOutline, {
    onClick: hide,
    className: styles$2.eye
  }) : /*#__PURE__*/React__default.createElement(io5.IoEyeOutline, {
    onClick: hide,
    className: styles$2.eye
  })), open && /*#__PURE__*/React__default.createElement("ul", null, material.fragmentShader && /*#__PURE__*/React__default.createElement(LiMenu, {
    program: program,
    type: 'frag'
  }), material.vertexShader && /*#__PURE__*/React__default.createElement(LiMenu, {
    program: program,
    type: 'vert'
  }))) : null;
};
...
var HeadMenu = function HeadMenu() {
  ...
  }, editorState.showEditor && editorState.fullScreen && /*#__PURE__*/React__default.createElement(bi.BiDockRight, {
    onClick: function onClick() {
      editorState.fullScreen = false;
    }
  }), editorState.showEditor && !editorState.fullScreen && /*#__PURE__*/React__default.createElement(ai.AiOutlineFullscreen, {
    onClick: function onClick() {
  ...
  }, snapshot.showEditor ? /*#__PURE__*/React__default.createElement(bs.BsArrowBarRight, null) : /*#__PURE__*/React__default.createElement(bs.BsArrowBarLeft, null)));
};
...
var BottomAction = function BottomAction() {
  ...
  return snapshot.activeMaterial && snapshot.activeMaterial.isModif && snapshot.showEditor && material ? /*#__PURE__*/React__default.createElement("div", {
    key: snapshot.triggerUpdate,
    className: styles$2.menub
  }, snapshot.obcMode && /*#__PURE__*/React__default.createElement("div", {
    className: "" + styles$2.menubaction,
    onClick: function onClick() {
      editorContextState.editor.trigger('source', 'editor.action.clipboardCopyAction');
    }
  }, /*#__PURE__*/React__default.createElement(hi.HiOutlineClipboardCopy, null), " Copy"), !snapshot.diffMode && !snapshot.obcMode && /*#__PURE__*/React__default.createElement("div", {
    className: styles$2.menubaction,
    onClick: function onClick() {
      editorState.diffMode = true;
    }
  }, /*#__PURE__*/React__default.createElement(vsc.VscCompareChanges, null), " Analyze diff"), snapshot.diffMode && !snapshot.obcMode && /*#__PURE__*/React__default.createElement("div", {
  ...
  }, /*#__PURE__*/React__default.createElement(ai.AiOutlineFunction, null), " onBeforeCompile"), !snapshot.obcMode && !snapshot.diffMode && /*#__PURE__*/React__default.createElement("div", {
    className: styles$2.menubaction + " " + styles$2.closemenubaction + " " + styles$2.resetmenub,
    onClick: cancelChange
  }, /*#__PURE__*/React__default.createElement(bi.BiEraser, null), " Reset shader")) : null;
};
...
var UniformsMenu = function UniformsMenu() {
  ...
  return /*#__PURE__*/React__default.createElement("div", null, /*#__PURE__*/React__default.createElement(leva.Leva, {
    fill: true,
    flat: true,
    hideTitleBar: true,
    oneLineLabels: false
  }), /*#__PURE__*/React__default.createElement(leva.LevaPanel, {
    fill: true,
    flat: true,
    hideTitleBar: true,
    store: store,
    ...
    key: snapshot.triggerUpdate
  }, /*#__PURE__*/React__default.createElement(UniformComp, {
...
var loadTexture = function loadTexture(uniforms, materialUniform, key, value) {
  if (materialUniform && materialUniform.value && materialUniform.value.image) {
    if (value && value !== materialUniform.value.image.preventDouble) {
      new THREE.TextureLoader().load(value, function (x) {
      ...
      new THREE.TextureLoader().load(materialUniform.copyRef, function (x) {
        materialUniform.value = x;
        materialUniform.value.wrapS = materialUniform.value.wrapT = THREE.RepeatWrapping;
        materialUniform.value.image.preventDouble = value;
...
var UniformComp = function UniformComp(_ref4) {
  ...
  var store = leva.useCreateStore();

  var _useControls = leva.useControls(function () {
...
var Menu = function Menu() {
  var snapshot = valtio.useProxy(editorState);
  var editorWidth = exports.editorContext.editorWidth;
  var editorHeight = exports.editorContext.editorMinusHeight;
  var menuSize = 160;
  var bind = reactUseGesture.useDrag(function (_ref) {
    ...
    if (down && typeof window !== 'undefined') {
      ...
      exports.editorContext.dom.current.style.setProperty('--editor-width', editorWidth + 'px');
      exports.editorContext.dom.current.style.setProperty('--editor-minus-height', editorHeight + 'px');
    } else {
      ...
      exports.editorContext.editorWidth = editorWidth;
      exports.editorContext.editorMinusHeight = editorHeight;
    }
  });
  return exports.editorContext.programs.length > 0 ? /*#__PURE__*/React__default.createElement("div", Object.assign({
    className: styles$2.menu + " " + (!snapshot.showEditor ? styles$2.menurh : '') + " " + (snapshot.showEditor && snapshot.fullScreen ? styles$2.full : '')
  }, bind(), {
    style: {
      touchAction: 'none'
    }
  }), /*#__PURE__*/React__default.createElement(HeadMenu, null), /*#__PURE__*/React__default.createElement("div", {
    key: snapshot.triggerUpdate,
    className: styles$2.menulist
  }, exports.editorContext.programs.map(function (value, key) {
    return /*#__PURE__*/React__default.createElement(SubMenu, {
      program: value,
      key: key.toString()
    });
  })), /*#__PURE__*/React__default.createElement(UniformsMenu, null), /*#__PURE__*/React__default.createElement(BottomAction, null)) : null;
};

var FullScreen = function FullScreen() {
  var snapshot = valtio.useProxy(editorState);
  var embed = React.useRef(null);
...
var checkIfModifications = function checkIfModifications() {
  var oModel = exports.editorContext.monacoRef.editor.getModel(editorState.activeMaterial.model + '_orig');
  var mModel = exports.editorContext.monacoRef.editor.getModel(editorState.activeMaterial.model);
...
var updateActiveShader = function updateActiveShader(value, type) {
  ...
  var activeMat = exports.editorContext.activeMaterialRef[editorState.activeMaterial.model];
  var material = activeMat.material;
  exports.editorContext.monacoRef.editor.setModelMarkers(exports.editorContext.editor.getModel(), editorState.activeMaterial.model, value);
  ...
  if (material) {
    if (material.isEffect) {
      ...
      activeMat.effect.recompile(exports.editorContext.gl);
    } else {
...
var MaterialEditor = function MaterialEditor() {
  ...
  React.useLayoutEffect(function () {
    if (typeof window !== "undefined" && !exports.editorContext.monacoRef) {
      Editor.loader.init().then(function (monacoInstance) {
        exports.editorContext.monacoRef = monacoInstance;
        exports.editorContext.monacoRef.editor.defineTheme('monokai', Monokai);
  ...
  return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, instanceReady && /*#__PURE__*/React__default.createElement(EditorDom, null));
};
...
var handleEditorValidation = function handleEditorValidation() {
  ...
  var material = exports.editorContext.activeMaterialRef[editorState.activeMaterial.model].material;

  if (diagnostics && diagnostics.fragmentShader && !diagnostics.runnable && exports.editorContext.monacoRef) {
    ...
    var markets = errs.map(function (err) {
      if (material && material.isEffect && exports.editorContext.editor) {
        var type = editorState.activeMaterial.type;
        ...
        var model = exports.editorContext.editor.getModel();
      ...
      return {
        ...
        severity: exports.editorContext.monacoRef.MarkerSeverity.Error
      };
    });
    exports.editorContext.monacoRef.editor.setModelMarkers(exports.editorContext.editor.getModel(), editorState.activeMaterial.model, markets);
  }
};
...
var EditorDom = function EditorDom() {
  ...
  }, /*#__PURE__*/React__default.createElement(Menu, null), editorContextState.gl && /*#__PURE__*/React__default.createElement(FullScreen, null), snapshot.showEditor && /*#__PURE__*/React__default.createElement(EditorText, null));
};
...
var EditorEdit = function EditorEdit() {
  ...
  function handleEditorDidMount(editor, _) {
    exports.editorContext.editor = editor;
    setIsEditorReady(true);
  }

  React.useEffect(function () {
    // at initialization of any new active material set the 2 models
    if (editorState.activeMaterial && exports.editorContext.activeMaterialRef && exports.editorContext.monacoRef && editorState.activeMaterial.model) {
      var type = editorState.activeMaterial.type;
      var activeMat = exports.editorContext.activeMaterialRef[editorState.activeMaterial.model];
      ...
      if (isEditorReady && material) {
        ...
        if (!exports.editorContext.monacoRef.editor.getModel("urn:" + name + "." + type + "_orig")) {
          exports.editorContext.monacoRef.editor.createModel(textContent, 'cshader', "urn:" + name + "." + type + "_orig"); // TODO ADD OPTION

          if (material.type !== 'ShaderMaterial' && material.type !== 'RawShaderMaterial' && !material.isEffect) {
            exports.editorContext.editor.trigger('fold', 'editor.foldLevel1');
          }
        }
      }
    }
  }, [isEditorReady, snapshot.activeMaterial, exports.editorContext.monacoRef]);
  ...
  var getText = function getText() {
    ...
    if (model === 'urn:obc_result' && editorState.obcMode) {
      ...
      if (exports.editorContext.monacoRef.editor.getModel('urn:obc_result')) {
        exports.editorContext.monacoRef.editor.getModel('urn:obc_result').setValue(result);
      }
  ...
  return /*#__PURE__*/React__default.createElement(Editor__default, {
...
var GetDiff = function GetDiff() {
  ...
  function handleEditorDidMount(editor, _) {
    exports.editorContext.diffEditor = editor;
    setIsEditorReady(true);
  }

  var originalModel = exports.editorContext.monacoRef.editor.getModel(model + '_orig');
  var modifiedModel = exports.editorContext.monacoRef.editor.getModel(model);
  React.useEffect(function () {
    if (isEditorReady) {
      if (!exports.editorContext.monacoRef.editor.getModel('diff_1')) {
        exports.editorContext.monacoRef.editor.createModel(originalModel.getValue(), 'cshader', "diff_1");
      }

      if (!exports.editorContext.monacoRef.editor.getModel('diff_2')) {
        exports.editorContext.monacoRef.editor.createModel(modifiedModel.getValue(), 'cshader', "diff_2");
      }

      exports.editorContext.diffEditor.setModel({
        original: exports.editorContext.monacoRef.editor.getModel('diff_1'),
        modified: exports.editorContext.monacoRef.editor.getModel('diff_2')
      });
    }

    return function () {
      if (exports.editorContext.editor.getModel() && exports.editorContext.diffEditor.getModel().modified.getValue()) {
        // send the update in the diff to the basic text editor
        exports.editorContext.monacoRef.editor.getModel(editorState.activeMaterial.model).setValue(exports.editorContext.diffEditor.getModel().modified.getValue());
      }

      var navi = exports.editorContext.monacoRef.editor.createDiffNavigator(exports.editorContext.diffEditor, {
        followsCaret: true,
  ...
  return /*#__PURE__*/React__default.createElement(Editor.DiffEditor, {
    className: styles.editor,
    onMount: handleEditorDidMount,
    theme: 'vs-dark',
    height: '100%',
...
var EditorText = function EditorText() {
  var snapshot = valtio.useProxy(editorState); // implement multi-tab for vertex and frag using createModel

  return snapshot.showEditor ? /*#__PURE__*/React__default.createElement(React__default.Fragment, null, snapshot.activeMaterial.type && /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(HandleError, null), /*#__PURE__*/React__default.createElement(EditorTabs, null)), Object.keys(snapshot.tabs).length > 0 && /*#__PURE__*/React__default.createElement(EditorEdit, null), snapshot.showEditor && snapshot.diffMode && snapshot.activeMaterial.type && /*#__PURE__*/React__default.createElement(GetDiff, null)) : null;
};
...
var addShaderDebugMaterial = function addShaderDebugMaterial(material) {
  ...
  var res = new THREE.Vector2(canvas.clientWidth, canvas.clientHeight); // add a uniform time helper for animations
...
var meshDebugger = /*#__PURE__*/new THREE.Mesh(undefined, /*#__PURE__*/new THREE.MeshBasicMaterial({
  color: /*#__PURE__*/new THREE.Color(0xff0000),
...
exports.EditorDom = function EditorDom() {
  return null;
};
exports.editorState = {};
exports.editorContext = {};
exports.materialsToProgram = {};

{
  exports.EditorDom = function EditorDom() {
    return /*#__PURE__*/React__default.createElement(MaterialEditor, null);
  };

  exports.editorState = editorState;
  exports.editorContext = editorContextState;
  exports.materialsToProgram = traverseMaterialsToProgram;
}
