...
export declare const Plugins: Record<string, Omit<Plugin<any, any, any>, 'schema'>>;
 ...
 * @param plugin
 */
export declare function register<Input, Value, InternalSettings, Settings>(type: string, { schema, ...plugin }: InternalPlugin<Input, Value, Settings, InternalSettings>): void;
/**
 ...
 * @param plugin
 */
export declare function createPlugin<Input, Value, InternalSettings>(plugin: Plugin<Input, Value, InternalSettings>): (input?: Input | undefined) => CustomInput<Value>;
export declare function normalize<V, Settings extends object = {}>(type: string, input: InputWithSettings<V, Settings>): {
    value: any;
    settings?: any;
} | InputWithSettings<V, Settings>;
export declare function sanitize<Settings extends object>(type: string, value: any, settings?: Settings, prevValue?: any): any;
